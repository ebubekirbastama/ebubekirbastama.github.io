const CACHE='ebs-kutuphane-v1.1.0';
const ASSETS=['./','./index.html','./manifest.webmanifest','./assets/style.css','./assets/app.js','./assets/sample-books.js','./ornek-kitap-import.csv','./assets/ebs-logo.png','./assets/icon-192.png','./assets/icon-512.png'];
